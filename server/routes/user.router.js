...
router.post('/register', (req, res, next) => {
  ...
  const is_staff = req.body.is_staff;
  const is_admin = req.body.is_admin;

  const queryText = `INSERT INTO "user" (username, password, first_name, last_name, is_staff, is_admin)
    VALUES ($1, $2, $3, $4, $5, $6) RETURNING id`;
  pool
    .query(queryText, [username, password, first_name, last_name, is_staff, is_admin])
